...
public class TSP {
    ...
    static ArrayList<data> allpaTH= new ArrayList<data>();
...
*/
    ...
    public static void NearestNeighbourcost(int i){
        allpaTH.add(nodeCO.get(i));
        getTSPPathcost(i);
        allpaTH.add(nodeCO.get(i));
    }
    ...
    public static void cost(){
        ...
        System.out.println("Minimum Cost: "+mn);
        System.out.println("\nMinimum Position: "+mnpos);
        System.out.println("\nMaximum Cost: "+mx);
        System.out.println("\nMaximum Position: "+mxpos);
    ...
    public static void getTSPPathcost(int sNode){
        nodeCO.get(sNode).visited=true;
        while (checkNonVisited()){
            int explored=getMinimumOfColumn(sNode);
            allpaTH.add(nodeCO.get(explored));
            getTSPPath(explored);
        }
    }
